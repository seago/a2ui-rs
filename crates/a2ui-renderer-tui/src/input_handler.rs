...
impl InputHandler {
    ...
    pub fn handle_key(&self, key: &str) -> Option<UserEvent> {
        match key {
            "Enter" => Some(UserEvent::KeyPress { key: "Enter".into() }),
            "Escape" => Some(UserEvent::KeyPress { key: "Escape".into() }),
            "Tab" => Some(UserEvent::KeyPress { key: "Tab".into() }),
            "Backspace" => Some(UserEvent::KeyPress { key: "Backspace".into() }),
            "Delete" => Some(UserEvent::KeyPress { key: "Delete".into() }),
            ...
            "Right" => Some(UserEvent::KeyPress { key: "Right".into() }),
