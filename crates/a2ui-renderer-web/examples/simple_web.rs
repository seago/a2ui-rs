...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // 分割线
    let divider1: Component = Component::from_value(json!({
        "id": "divider1", "component": "Divider"
    }))?;
    let divider2: Component = Component::from_value(json!({
        "id": "divider2", "component": "Divider"
    }))?;
    let divider3: Component = Component::from_value(json!({
        "id": "divider3", "component": "Divider"
    }))?;
    let divider4: Component = Component::from_value(json!({
        "id": "divider4", "component": "Divider"
    }))?;

    // 卡片（内嵌文本描述）
    let card_text: Component = Component::from_value(json!({
        "id": "card_text",
        "component": "Text",
        "text": "这是 A2UI Web 渲染器的演示页面。所有组件均由 Rust 后端渲染为语义化 HTML，支持 XSS 安全转义。"
    }))?;
    let card1: Component = Component::from_value(json!({
        "id": "card1",
        "component": "Card",
        "child": "card_text"
    }))?;
    ...
    // 表单行（输入组件）
    let name_input: Component = Component::from_value(json!({
        "id": "name_input",
        "component": "TextField",
        "value": "",
        "placeholder": "请输入姓名",
    ...
    let email_input: Component = Component::from_value(json!({
        "id": "email_input",
        "component": "TextField",
        "value": "",
        "placeholder": "请输入邮箱",
    ...
    let agree_cb: Component = Component::from_value(json!({
        "id": "agree_cb",
        "component": "CheckBox",
        "checked": true,
        "label": "同意服务条款"
    }))?;
    let volume_slider: Component = Component::from_value(json!({
        "id": "volume_slider",
        "component": "Slider",
        "value": 75,
        "min": 0,
    ...
    let form_row: Component = Component::from_value(json!({
        "id": "form_row",
        "component": "Row",
        "children": { "children": [
    ...
    let submit_btn: Component = Component::from_value(json!({
        "id": "submit_btn",
        "component": "Button",
        "child": "submit_label",
        "variant": "primary",
    ...
    let cancel_btn: Component = Component::from_value(json!({
        "id": "cancel_btn",
        "component": "Button",
        "child": "cancel_label",
        "variant": "default",
    ...
    let img_placeholder: Component = Component::from_value(json!({
        "id": "img_placeholder",
        "component": "Image",
        "url": "https://via.placeholder.com/80x80.png?text=A2UI"
    }))?;
    let actions_row: Component = Component::from_value(json!({
        "id": "actions_row",
        "component": "Row",
        "children": { "children": [
    ...
    let list_section: Component = Component::from_value(json!({
        "id": "list_section",
        "component": "List",
